...
public class AggregationHandler {
    ...
    /**
     * @param columnAggregators the columnAggregators to set
     */
    ...
    /**
     * @param columnHierarchyAggregators the columnHierarchyAggregators to set
     */
    ...
    /**
     * @param columnMemberAggregators the columnMemberAggregators to set
     */
    ...
    /**
     * @param rowAggregators the rowAggregators to set
     */
    ...
    /**
     * @param rowHierarchyAggregators the rowHierarchyAggregators to set
     */
    ...
    /**
     * @param rowMemberAggregators the rowMemberAggregators to set
     */
