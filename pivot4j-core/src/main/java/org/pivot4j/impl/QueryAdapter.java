...
public class QueryAdapter implements Bookmarkable {
    ...
    /**
     * @param quaxToSort the quaxToSort to set
     */
     ...
     * executed.
     *
     * @param cellSet the result which redefines the query axes
     */
    ...
    /**
     * @param pathMembers positions to be collapsed
     ...
     *
     * @param member Member to drill down
     */
