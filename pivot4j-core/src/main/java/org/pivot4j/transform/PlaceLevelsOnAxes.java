...
public interface PlaceLevelsOnAxes extends Transform {
     ...
     * @param levels The levels to put
     */
     ...
     * @param position The position index where to add the level. Any value less
     * than ZERO will put the hierarchy at the end of the axis. Note that it's
     * the index of the parent hierarchy, not the level itself since the order
     * of a level in a hierarchy cannot be changed by definition. If the parent
     * hierarchy exists on any axis, the position argument will be ignored.
     */
