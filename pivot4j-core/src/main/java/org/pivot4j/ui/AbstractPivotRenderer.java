...
public abstract class AbstractPivotRenderer<T1 extends RenderContext, T2 extends RenderCallback<T1>>
    ...
    /**
     * @see
     * org.pivot4j.ui.PivotRenderer#addCommand(org.pivot4j.ui.command.UICommand)
     */
    @Override
    ...
    /**
     * @param enableDrillDown the enableDrillDown to set
    ...
    /**
     * @param enableSort the enableSort to set
    ...
    /**
     * @param enableDrillThrough the enableDrillThrough to set
    ...
    /**
     * @param propertyCollector the propertyCollector to set
     */
    @Override
    ...
    /**
     * @param aggregatorFactory the aggregatorFactory to set
     */
    ...
    /**
     * @param conditionFactory the conditionFactory to set
     */
    ...
    /**
     * @see
     * org.pivot4j.ui.property.DefaultRenderPropertyList#restoreState(java.io.Serializable)
     */
    ...
    /**
     * @see
     * org.pivot4j.ui.property.DefaultRenderPropertyList#saveSettings(org.apache.commons.configuration.HierarchicalConfiguration)
     */
    @Override
