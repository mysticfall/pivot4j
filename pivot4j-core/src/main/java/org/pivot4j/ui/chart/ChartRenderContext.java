...
public class ChartRenderContext extends CartesianRenderContext {
    ...
    /**
     * @param chartIndex the chartIndex to set
     */
    ...
    /**
     * @param plotIndex the plotIndex to set
     */
    ...
    /**
     * @param chartCount the chartCount to set
     */
    ...
    /**
     * @param seriesPath the seriesPath to set
     */
