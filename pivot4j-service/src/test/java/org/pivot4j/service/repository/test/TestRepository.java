...
public class TestRepository extends AbstractFileSystemRepository {

	private static final String RESOURCE_PREFIX = "/org/pivot4j/service/repository/test";
	...
	private Map<String, TestFile> filesById;
	...
	public void initialize() {
		...
		this.filesById = new HashMap<String, TestFile>();
