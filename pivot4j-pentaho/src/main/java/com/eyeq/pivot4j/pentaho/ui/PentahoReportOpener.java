...
import com.eyeq.pivot4j.analytics.ui.ReportOpener;
...
public class PentahoReportOpener extends ReportOpener {
	...
	/**
	 * @throws IOException
	 * @see com.eyeq.pivot4j.analytics.ui.ReportOpener#getReportFromRequest(javax.servlet.http.HttpServletRequest)
	 */
	@Override
	...
	/**
	 * @see com.eyeq.pivot4j.analytics.ui.ReportOpener#createViewWithRequest(javax.servlet.http.HttpServletRequest,
	 *      com.eyeq.pivot4j.analytics.repository.ReportFile)
	 */
	@Override
